...
page_title: "influxdb3_cloud_database Resource - terraform-provider-influxdb3"
subcategory: ""
description: |-
...
```shell
# Databases are imported by name.
terraform import influxdb3_cloud_database.signals signals
```
