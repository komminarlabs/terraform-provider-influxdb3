...
~> **Deprecated** This name is deprecated and will be removed in the next major version of the provider. Use the [`influxdb3_cloud_token`](./cloud_token) data source instead. See the [InfluxDB 3 deployment types and resource renaming guide](../guides/deployment-types-and-resource-renaming) for details.
